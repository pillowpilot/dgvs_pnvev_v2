    ...
    <nav>
        <ul>
            ...
            @foreach (\App\DiseaseV2::roots()->get() as $root)
                <li class="{{ Route::is('disease.show') && ($root->id == $activeDisease->id || $root->children()->find($activeDisease->id)) ? 'active' : '' }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ Route::is('disease.show') && $child->id == $activeDisease->id ? 'active' : '' }}">
